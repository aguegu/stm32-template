...
STD_PERIPH_LIBS = ../../STM32F10x_StdPeriph_Lib_V3.5.0/Libraries/STM32F10x_StdPeriph_Driver/src

C_SRCS += \
$(STD_PERIPH_LIBS)/misc.c \
$(STD_PERIPH_LIBS)/stm32f10x_gpio.c \
$(STD_PERIPH_LIBS)/stm32f10x_rcc.c
...
system/src/stm32f1-stdperiph/%.o: $(STD_PERIPH_LIBS)/%.c
	@echo 'Building file: $<'
